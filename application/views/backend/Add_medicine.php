            ...
            <div class="flashmessage"></div>
                ...
                <div class="row m-b-10"> 
                    ...
                    <div class="col-12">
                        ...
                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url('Medicine/View');?>" class="text-white">
                        <i class="" aria-hidden="true"></i> Manage Medicine </a></button>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-outline-info">
                            <div class="card-header">                                
                                <h4 class="m-b-0 text-white">New Medicine <span class="pull-right"><?php date_default_timezone_set("Africa/Tunis"); 
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 col-sm-12">
                                                        ...
                                                        <input type="text" required  class="form-control supplier_name" name="supplier_name" placeholder="Supplier Name..."  
                                                        id="supplier_name" autocomplete="off"> 
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 col-sm-12">
                                                        <input type="number" name="barcode" class="form-control barcode" placeholder="" 
                                                        value="<?php echo rand(100000000,1500000000)?>" required >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 col-sm-12">
                                                        ...
                                                        <input type="text"  required name="expire_date" class="form-control expire_date" placeholder="Expire Date" id="datepicker" required>
...
<!--                                        <div class="col-md-9 col-md-offset-3">
            ...
            <footer class="footer"> © 2021 Kam Company </footer>
