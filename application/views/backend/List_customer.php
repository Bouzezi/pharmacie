...
<!--                                                     <a href="#" title="Delete" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-trash-o"></i></a> -->
                                                    <a href="" title="imprimer" data-toggle="modal" class="btn btn-sm btn-info waves-effect waves-light barcodegenerator"  data-id="<?php echo $value->c_id; ?>"><i class="fa fa-barcode"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach;?>
                                        </tbody>
