                      ...
                      <div class="row m-b-5">
                        <div class="col-md-3 p-r-5">
                            <div class="input-group">
                                ...
                                <input type="text"  required class="form-control" name="cusid" id="cusid" placeholder="Barcode , Phone No..." tabindex="1" autocomplete="off" >
                        ...
                        <div class="col-md-3 p-l-r-5">
                           <div class="input-group" >
                            ...
                            <input type="text"  required class="form-control" name="customer_name" id="customer_name" placeholder="customer name">
                          </div>
                        </div>
                        <div class="col-md-3 p-l-5">
                           <div class="input-group" >
                            ...
                            <input type="text"  required class="form-control customer_id" name="customer_id" id="customer_id" placeholder="customer ID">
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="row">
                            <div class="col-md-6">
                                <span class="custom-text-button">
                                  Date:
                                  <?php date_default_timezone_set("Africa/Tunis"); echo date("j  M y") ?>                                    
                                </span>
                            </div>
                            <div class="col-md-6">
                                <span class="custom-text-button">
                                  Time:
                                  <?php date_default_timezone_set("Africa/Tunis"); echo date("h:i A") ?>                                  
                                </span>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="row pos-remove-spacing">
                            <div class="col-md-4">
                              <div class="input-group">
                                ...
                                <input type="text"  required class="form-control proval" name="proval" placeholder="Barcode , Product ID..."  id="product_name" tabindex="2" autocomplete="off">                                
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-group">
                                <input type="text"  required class="form-control proname" name="proname" id="proname" placeholder="Product Name"  autocomplete="off"><sup><h6 id="expiry" style="color:red;margin-top: 5px;position:absolute;"></h6></sup>
                              </div>
                            </div> 
                            <div class="col-md-3">
                              <div class="form-group genric-left-sug">
                                <input type="text"  required class="form-control genname" name="genname" id="genname" placeholder="Generic Name" required  autocomplete="off">
                              </div>
                            ...
                            <div class="col-md-2" style="">
                              <div class="form-group">
                                <input type="text"  required class="form-control qty" name="qty" max="" id="qty" placeholder="Qty " required tabindex="4" autocomplete="off">
                                <!-- TABINDEX RESET INPUT  -->
                                <input type="text"  required tabindex="5" onfocus="document.getElementById('product_name').focus()" style="position: fixed; top: 9999px; left: 9999px">
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="input-group">
                                ...
                                <input type="text"  required class="form-control mrp" name="mrp" id="mrp" placeholder="MRP" readonly tabindex="-1" value="">
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="input-group">
                                ...
                                <input type="text"  required class="form-control stock" name="stock" id="stock" placeholder="Stock " readonly tabindex="-1" value="">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          <div class="row form-group">
                            ...
                            <div class="col-md-7">
                              <input class="form-control grandtotal" name="grandtotal" type="text"  required value="" style="" tabindex="-1" readonly>
                            </div>
                          </div>
                          <div class="row form-group">
                            <div class="col-md-5">
                            ...
                            <div class="col-md-7">
                              <input class="form-control gdiscount" name="gdiscount" type="text"  required value="0" style="" tabindex="-1" readonly>
                            </div>
                          </div>
                          <div class="row form-group">
                            <div class="col-md-5">
                            ...
                            <div class="col-md-7">
                              <input class="form-control payable" name="payable" type="text"  required value="" style="" tabindex="-1" readonly>
                            </div>
                          </div>
                          <div class="row form-group">
                            <div class="col-md-5">
                            ...
                            <div class="col-md-7">
                              <input class="form-control pay" type="text"  required name="pay" value="" style="" tabindex="-1" required="1">
                            </div>
                          </div>
                          <div class="row form-group">
                            <div class="col-md-5">
                            ...
                            <div class="col-md-7">
                              <input class="form-control return" name="return" type="text"  required value="" style="" tabindex="-1">
                            </div>
                          </div>
                          <div class="row form-group">
                            <div class="col-md-5">
                            ...
                            <div class="col-md-7">
                              <input class="form-control due" name="due" type="text"  required value="" style="" tabindex="-1">
                            </div>
                          </div>
...
<!--<div class="modal fade" id="invoicemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    ...
    <footer class="footer"> © 2021 Kam Company 
    </footer>
  </div>
  <script>
