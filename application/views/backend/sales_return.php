                                           ...
                                           <?php foreach($salesreport as $value): ?>
                                            <tr>
                                                ...
                                                <td class="jsgrid-align-center ">
                                                    <a href="<?php echo base_url() ?>Sales/SalesReturn?S=<?php echo base64_encode($value->sale_id) ?>" 
                                                    title="Edit" class="btn btn-sm btn-info waves-effect waves-light customerid"  data-id="<?php echo $value->sale_id ?>">
