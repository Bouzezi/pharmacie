                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">                     
                            <div class="card-header">                                
                                <h4 class="m-b-0 text-white">New Purchase <span class="pull-right date-display"><?php date_default_timezone_set("Africa/Tunis"); echo date("l jS \of F Y h:i:s A") ?></span></h4>
                            </div>
                            <div class="card-body">
