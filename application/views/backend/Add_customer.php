                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-outline-info">
                            <div class="card-header">                                
                                <h4 class="m-b-0 text-white">New Customer <span class="pull-right date-display"><?php date_default_timezone_set("Africa/Tunis");
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <input type="email" required class="form-control cemail" name="cemail" placeholder="Email">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <input type="text" required class="form-control caddress" name="caddress" placeholder="address">
                                            ...
                                            <div class="col-md-6" id="tamount">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <input type="number" required name="tamount" class="form-control tamount" placeholder="">
                                            ...
                                            <div class="col-md-6" id="cregular">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <input type="number" required name="rdiscount" class="form-control rdiscount" placeholder="" >
                                            ...
                                            <div class="col-md-6" id="tdiscount">
                                                ...
                                                <div class="form-group row" >
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <input type="number" required name="tdiscount" class="form-control tdiscount" placeholder="Discount">
